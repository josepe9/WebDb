...
namespace WebDb.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AlumnoId,Nombre,Direccion,Telefono")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AlumnoId,Nombre,Direccion,Telefono")] Alumno alumno)
        {
